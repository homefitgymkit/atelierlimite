...
const AL_FAQ = [
  ...
  },
  {
    ...
    items: [
      { q: "Why \u201Ccertificate of edition\u201D and not \u201Cof authenticity\u201D?", a: "A certificate of authenticity confirms a piece is genuine. A certificate of edition does that and records the piece's specific position within a fixed, permanent run. 047/080 doesn't just authenticate — it establishes that this is the forty-seventh of exactly eighty pieces that will ever exist. The edition context is part of what makes the certificate meaningful." },
  ...
  },
  {
    ...
    items: [
      { q: "What is the private view list?", a: "Members get 48-hour early access to every edition before its public opening. A maximum of four emails per year — one per edition — written in gallery invitation tone. No promotional emails, no newsletters, no content between openings. The name is borrowed from the gallery world, where a private view is an invitation-only preview before a show opens publicly." },
      ...
      { q: "Why limit emails to four per year?", a: "A deliberate commitment to your attention. Most lists erode trust by sending more than they promised. Every email from us is the same thing: a new edition opening. The inbox silence between editions is part of what gives each one weight." },
    ],
  },
  {
    group: "For artists",
